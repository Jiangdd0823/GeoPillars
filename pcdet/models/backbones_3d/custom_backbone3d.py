...
class PillarRes18BackBone8x_4layer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x_conv1 = self.conv1(input_sp_tensor)  # nu [4, 32, 1440, 1440]     kitti [1600, 1408]
        x_conv2 = self.conv2(x_conv1)  # nu [4, 64, 720, 720]    kitti  [800, 704]
        x_conv3 = self.conv3(x_conv2)  # nu [4, 128, 360, 360]   kitti  [400, 352]
        x_conv4 = self.conv4(x_conv3)  # nu [4, 256, 180, 180]   kitti  [200, 176]
        # x_conv4 = x_conv4.dense()
        # x_conv5 = self.conv5(x_conv4)  # nu torch.Size([4, 256, 90, 90])
