...
from .custom_backbone3d import PillarRes18BackBone8x_4layer
from .spconv_backbone_2d import PillarBackBone8x_
...
__all__ = {
    ...
    'DSVT': DSVT,
    'PillarRes18BackBone8x_4layer': PillarRes18BackBone8x_4layer,
    'PillarBackBone8x_': PillarBackBone8x_,
}
